...
| `ocd.datalake_fallback_score`<br/>`OCD_DATALAKE_FALLBACK_SCORE`                               | No        | If `OCD_IGNORE_UNSCORED_INDICATORS` is set to `false`, this value will be used as a default for Datalake indicators without any score. Defaults to `0`. |
